...
sep & O separador entre colunas. O padrão é o caractere no conjunto {[},\t \\\textbackslash\textbackslash\textbar;:{]}. \\
...
formula\_as\_formula & Exibir fórmulas como fórmulas ``SUM(A1:A3)'' ou como valores ``3''\ldots{} ou ``8''.. \\
