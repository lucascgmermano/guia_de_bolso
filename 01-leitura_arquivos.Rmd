...
### rio::import_list()  
Importa uma lista de data frames de um vetor de nomes ou arquivo multi-objeto (planilha Excel, arquivo .Rdata etc) ([documentação](https://www.rdocumentation.org/packages/rio/versions/0.5.29/topics/import_list)).  
