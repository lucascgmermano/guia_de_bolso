...
### rio::import()
É um pacote que vem com a iniciativa de simplificar o procedimento de importação de arquivos de dados. É capaz de ler uma vasta lista de extensões de arquivos, vide (documentação)[https://www.rdocumentation.org/packages/rio/versions/0.5.29/topics/import].
