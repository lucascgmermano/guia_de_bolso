...
base::unlink() | Deleta uma pasta, ex. unlink("some_directory", recursive = TRUE).
...
### rio::import()
O rio é um pacote que vem com a iniciativa de simplificar o procedimento de importação e exportação de arquivos de dados. Na importação, é capaz de ler uma vasta lista de extensões de arquivos, sem a necessidade de especificar o formato. Ver [documentação](https://www.rdocumentation.org/packages/rio/versions/0.5.29/topics/import).
...
### rio::export()  
Semelhante a outros comandos de escrita de arquivos, o rio::export() permite gravar um data frame nos formatos habituais de texto. Para exportar uma lista de arquivos, usar o rio::export_list(). Ver [documentação](https://www.rdocumentation.org/packages/rio/versions/0.5.29/topics/export).  
